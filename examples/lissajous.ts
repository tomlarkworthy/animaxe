...
import * as OT from "../src/ObservableTransformer"; // TODO this should be in Ax
...
var timeVaryingPointList: /*Parameter.Parameter<number[][]>*/ OT.ObservableTransformer<canvas.CanvasTick, number[][]> = 
    (Parameter.trace(
