...
var bigSin = Parameter.sin(2).mapValue(function (x) { return Math.round(x * 40 + 50); });
var bigCos = Parameter.cos(2).mapValue(function (x) { return Math.round(x * 40 + 50); });
var fastCos = Parameter.cos(1).mapValue(function (x) { return Math.round(x * 38 + 50); });
var fastSin = Parameter.sin(1).mapValue(function (x) { return Math.round(x * 38 + 50); });
